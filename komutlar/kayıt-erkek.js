...
exports.run = async (client, message, args) => {
  const kayıtlı = message.guild.roles.find(r => r.id === "740887661761527811"); //buraya erkek rolünüzün id'sini koyun
  const kayıtlı2 = message.guild.roles.find(r => r.id === "740887662965162004"); //buraya erkek rolünüzün id'sini koyun
...
exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ["e", "erkek", "man"], // Gibieklersen e, erkek , man v.s yazdığında komut çalışır. eyw
  permLevel: 0
};
exports.help = {
  name: "e",
